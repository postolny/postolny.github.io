...
- 32x32 px – стандартные иконки (в различных меню, в кнопках кнопки, в панели задач)
...
- 256x256 px – для экранов HD, Retina, и магазинов приложений
...
Иконки всех этих разрешений также могут использоваться в интерфейсах программ.
...
Кое-кто станет ругаться, мол: "эта программа работает через командную строку, интерфейса не имеет!". Но ведь так интересней. А если вам не интересно, то существует множество программ с интерфейсом, с помощью которых вы можете сделать то же самое (например, [Ultimate Icon Converter](http://www.winscreen.ru/programs/110-ultimate-icon-converter-udobnyy-konverter-ikonok.html){:target="_blank" rel="noopener noreferrer"} или [Quick Any2Ico](https://www.carifred.com/quick_any2ico/){:target="_blank" rel="noopener noreferrer"}. Цель же моей статьи – объяснить почему иконка ICO должна быть многослойной, а уж средства вы вольны выбирать сами.
{: .cornice}
...
Вот таким не самым простым, но вместе с тем и не сложным способом мы создали многослойную иконку ICO.