...
В статье [Нотный редактор MuseScore]({{ site.baseurl }}/2021-12-24/musescore) я конснулся некоторых трудностей, которые могут возникнуть при работе в нотном редакторе MuseScore.