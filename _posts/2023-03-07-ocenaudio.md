...
При последующем запуске Ocenaudio в правом верхнем углу появится окошко, в котором будет указано, что Ocenaudio обнаружил в системе новый VST-плагин и что следует кликнуть на это окошко, чтобы активировать (загрузить) плагин:
...
Плагин создаёт псевдостереофонический эффект, поэтому если ваша запись была монофонической, до применения эффекта реверберации конвертируйте её в стереофоническую. Для этого нажмите "Правка" → "Convert To Stereo".
{: .cornice}
