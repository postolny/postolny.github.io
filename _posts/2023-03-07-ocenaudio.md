...
* Для удаления выделенного участка нажать <kbd>delete</kbd>, для вырезания выделенного участка – <kbd>Ctrl</kbd> + <kbd>X</kbd>, для копирования выделенного участка – <kbd>Ctrl</kbd> + <kbd>C</kbd>, для вставки в выделенный участок – <kbd>Ctrl</kbd> + <kbd>V</kbd>, для обрезки выделенного участка (оставить только выделенный участок) – <kbd>Ctrl</kbd> + <kbd>T</kbd> (все эти действия (кроме удаления) можно выполнить также через контекстное меню, а также все эти действия можно выполнить нажимая на соответствующие значки на панели инструментов).
* По наведению на выделенный участок появятся указания продолжительности, времени начала и конца участка, которые можно корректировать (нажать <kbd>Enter</kbd> чтобы изменения вступили в силу), значок "Тащи меня!" – захватив его мышкой и удерживая левую клавишу можно перетаскивать участок по тамлайну или же можно перетащить участок в список файлов слева, значок лупы – выделенный участок можно увеличить.
...
* Слева от значка в виде регулятора громкости находятся значки "Fade In" и "Fade Out" с помощью которых на выделенном участке можно создать соответственно постепенное нарастание и постепенное уменьшение силы звука (то же самое можно сделать через меню: "Эффекты" → "Амплитуда" → "Нарастание силы звука" / "Уменьшение силы звука" / "Затухание").
