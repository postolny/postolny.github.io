...
Когда в разделе "Каналы" следует выбирать "Стерео" (т.е. два канала)? В том случае, если вы записываете двумя микрофонами или стереомикрофоном. В каких случаях запись бывает стереофонической? Когда записывают оркестр, хор, ансамбль, солиста и концертмейстера, большой музыкальный инструмент (например, пианино или рояль) или может быть птичек в лесу – во всех подобных случаях могут использоваться два или несколько монофонических микрофонов (как я уже писал, для записи фортепиано, мне приходится довольствоваться одним микрофоном). Для певца, диктора микрофон следует использовать монофонический. В аудиоредаторе, конечно можно записать монофонический сигнал на два канала, указав "Стерео" в разделе "Каналы", но такая запись не превратится в стереофоническую, хоть и будет двухканальной.
