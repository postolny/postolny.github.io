...
VST-плагины представляют собой файлы с расширением dll. Установим бесплатный плагин Verberate Basic для создания эффекта "Реверберация". С [официального сайта плагина](https://acondigital.com/products/verberate-basic) загрузите установщик и запустите установку. В процессе установки в окне выбора компонентов оставьте отмеченным пункт "Install VST plug-in":

![VerberateBasic2]({{ site.baseurl }}/img/ocenaudio/VerberateBasic2.png)

При последующем запуске Ocenaudio в правом верхнем углу появится окошко, в котором будет указано, что Ocenaudio обнаружил в системе новый VST-плагин и что следует кликнуть на это окошко, чтобы активировать плагин:
...
Для активациии плагина установите галочку слева от VerberateBasic2.dll (или кликните на VerberateBasic2.dll правой клавишей мышки и в контекстном меню выберите "Enaable Plugin"). Если справа вы увидите запись "Loaded", это будет означать, что плагин активирован:
...
Реверберация – это псевдо стереофонический эффект, поэтому если ваша запись была монофонической, до применения эффекта реверберации конвертируйте её в стереофоническую. Для этого нажмите "Правка" → "Convert To Stereo".
{: .cornice}

Также для установки плагина вы можете указать путь до места нахождения dll-файла. Для этого откройте окно настроек плагинов: "Эффекты" → "VST" → "Plugin Preferences" и нажмите на кнопку "Add Path" внизу окна слева. Укажите директорию `VstPlugins` по адресу `C:\Program Files\VstPlugins\Acon Digital`. Активируйте плагин.
