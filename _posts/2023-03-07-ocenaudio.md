...
* Курсор можно перетаскивать за утолщение в его нижней части, с помощью клавиш <kbd>◄</kbd> и <kbd>►</kbd>, нажатие клавиши <kbd>end</kbd> переместит курсор в конец дорожки, нажатие клавиши <kbd>home</kbd> переместит курсор в начало дорожки.
...
2. Выбираем в главном меню "Эффекты" → "Шумоподавление" → "Шумоподавление..." и в открышемся окне  "Шумоподавление" в первой вкладке "Профилировщик шума" нажимаем на кнопку "Получить профиль" и затем нажимаем на кнопку "Закрыть".
3. Полностью выделяем всю область звука.
4. Снова выбираем в главном меню "Эффекты" → "Шумоподавление" → "Шумоподавление..." и в открышемся окне "Шумоподавление" нажимаем на кнопку "Применить".

В аудиоредакторе имеется и автоматическое шумоподавление ("Эффекты" → "Шумоподавление" → "Авто-шумоподавление"), но применение данной функции может вызвать искажение звука. 

Надо сказать, что любые эффекты, в том числе и шумоподавление, могут привести к потери естественности звучания. Поэтому эффекты нужно применять с осторожностью. Например, применение эффектов постепенного нарастания силы звука и постепенного уменьшения силы звука будет совершенно неуместно для классической музыки.
{: .cornice}