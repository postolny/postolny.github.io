...
* С помощью значков в виде трёх вертикальных линий ![resize]({{ site.baseurl }}/img/ocenaudio/resize.png){: .inln} можно менять размеры области просмотра. С помощью такого значка справа можно показать / скрыть визуализатор звука. Для этого нужно этот значок переместить, ухватив его мышкой.
