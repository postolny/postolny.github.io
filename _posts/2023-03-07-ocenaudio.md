...
На [сайте](https://www.macaulaylibrary.org/resources/audio-editing-tutorials/prepare-sound-files-in-ocenaudio/) медиатеки Маколея[^1] я нашёл информацию, что пиковый уровень записей, хранящихся в этой медиатеке, составляет -3dB и как я понимаю является неким стандартом.
