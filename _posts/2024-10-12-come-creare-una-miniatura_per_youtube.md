...
Если созданная вами обложка имеет размер более 500 кб, то имеет смысл сжать созданное вами изображение (хотя YouTube позволяет загружать изображения весом до 2 мб). Для этого настроqте параметры сжатия в процессе экспорта вашей работы или же воспользуйтесь специальной программой, например, [Caesium](https://saerasoft.com/caesium).
{: .cornice}
