...
farci la birra
loc.v. CO colloq., iron., per indicare che qcs. è inservibile, inutilizzabile: con quel rottame ormai puoi farci la birra (чтобы указать, что что-либо бесполезно, непригодно для использования: теперь вы можете варить пиво из этих отходов). [Dizionario italiano De Mauro](https://dizionario.internazionale.it/parola/farci-la-birra)
