...
description: "Для того, чтобы выразить желание пресечь что либо в корне (на корню), уничтножить в зародыше можно использовать следующую конструкцию: подходящий глагол + sul nascere (в зародыше, в самом начале)."
author: "И. Постольный"
comments: false
categories: 
tags: Frasi
...
Для того, чтобы выразить желание пресечь что либо в корне (на корню), уничтножить в зародыше можно использовать следующую конструкцию: подходящий глагол + sul nascere (в зародыше, в самом начале). Вот некоторые примеры:
