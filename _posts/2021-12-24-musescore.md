...
В качестве ещё одного примера я взял двадцать седьмой такт ноктюрна №14 Фридерика Шопена:

![nocturne]({{ site.baseurl }}/img/musescore/nocturne.png)

В этом примере в окне "Создать мультиоль" следует указать соотношение 21/16. Для того, чтобы точно передать нотный текст пьесы из Полного собрания сочинений Фридерика Шопена в редакции Падеревского и в левой руке первую ноту сделать как восьмой, так и половинной, я изменил в "Инспекторе" тип головки ноты, а в качестве штиля половинной ноты использовал символ "вертикальная линия" из "Палитры символов" (раздел "Символы") со смещением по оси X на 1,23sp. Вертикальные линии в обозначении педали не будут отображаться при печати – их видимость отключена в "Инспекторе", равно как не будет отображаться пунктирная рамка.
