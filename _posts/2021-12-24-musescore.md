...
3. Тулбар настраивается – на него я добавил ноту с двумя точками и ноту с тремя точками, общее ребро и 3 и 4 голоса.
4. В MuseScore 4 как и в MuseScore 3 нельзя заключить орнаментику (например, мордент) в скобки из "Панели инструментов".
5. Функция "Захват изображения", имеющаяся в MuseScore 3 пока не реализована.
6. Функция "Создание альбома", имеющаяся в MuseScore 2 не реализована.
7. Много изменений в плане воспроизведения.
