...
description: "Несколько решений по работе с нотный редактором MuseScore."
author: "И. Постольный"
comments: false
categories: 
tags: Музыка
...
MuseScore – бесплатный нотный редактор, в котором можно набрать практически любой нотный текст. На [официальном сайте](https://musescore.org/ru) программы имеется подробное [руководство по использованию](https://musescore.org/ru/handbook), а также обучающие [видеоматериалы](https://musescore.org/ru/tutorials). Но некоторые вещи хотелось бы рассмотреть подробнее, что я и постараюсь сделать в этой статье.
