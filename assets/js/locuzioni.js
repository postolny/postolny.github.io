$(function () {
  var locuzioniAry = [
    ...
    "Ha tempo adesso? Sì ho qualche minuto adesso. – У Вас есть сейчас время? Да, у меня сейчас есть несколько минут.",
    ...
    "È gentile e bravo con le parole. – Он умеет себя вести и красиво говорить.",
    "Non sono bravo a parlare. – Я не умею красиво говорить.",
    "Persino io l'ho capito adesso. – Даже я это понял.",
    "Grazie, per me significa molto. – Спасибо. Это для меня много значит.",
    "Ma adesso... significa molto di più. – Но сейчас, оно значит для меня гораздо больше.",
    "Significa molto, detto da te. – Твои слова много для меня значат.",
    "Per me significa molto che vogliate aiutarmi. – Для меня это значит много, что вы хотите помочь.",
    "Sono felice che tu sia dalla mia parte, significa molto. – Я рада, что ты в этом со мной.",
